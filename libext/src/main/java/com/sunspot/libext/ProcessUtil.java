...
public class ProcessUtil {
    ...
    private final static String TAG = "ProcessUtil";
    /**
        ...
        if (closeable != null) {
            if (hideException) {
                try {
                    ...
                    Log.e(TAG, "Hiding IOException because another is pending", e);
                }
            } else {
                closeable.close();
            }
    ...
    public static boolean isMainProcess() {
        return PackageUtils.getPackageName(AppContext.getInstance().getContext()).equals(ProcessUtil.getProcessName());
    }
}
